...
import { FileUp, Copy, Check, Type, RefreshCw, X, Wrench, FileCode, Binary } from 'lucide-vue-next'

const toastStore = useToastStore()
const activeToolTab = ref('Base64') // 'Base64' (File to Base64), 'Codec' (Encoding/Decoding)
